...
git add ./
git commit -m "$date"
git remote set-url origin https://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@github.com/hebe061103/clash.git
